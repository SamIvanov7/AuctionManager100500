<?php
namespace classes\delete_auth_errors_list;

if(!$is_require) {
	require $_SERVER['DOCUMENT_ROOT'].'/classes/get_404.php';
}

class delete_auth_errors_list extends \classes\common\common {
	...
	public function __construct(){
		...
		$file_path = $this->config->install_dir_auction_manager_app.'/log_error_auth/'.$id;
		if(file_exists($file_path)){
			unlink($file_path);
		}
